        ...
        private static void SeedUserReports(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<UserReport>().HasData(
                new UserReport
                {
                    ...
                    ReporterId = 2,
                    ReportedUserId = 10,
                    Header = "Deliberate spoilers",
                    Description = "Repeatedly posting unmarked plot spoilers in review comments after being asked to use the spoiler flag.",
                    Status = ReportStatus.Resolved,
                ...
                new UserReport
                {
                    ...
                    ReporterId = 9,
                    ReportedUserId = 10,
                    Header = "Inappropriate reviews or lists",
                    Description = "Copied the text of another member's review word for word and posted it under their own account.",
                    Status = ReportStatus.Resolved,
                ...
                new UserReport
                {
                    ...
                    ReporterId = 5,
                    ReportedUserId = 6,
                    Header = "Harassment or bullying",
                    Description = "Hostile replies on a clash entry, including personal remarks unrelated to the films listed.",
                    Status = ReportStatus.Open,
                ...
                new UserReport
                {
                    ...
                    ReportedUserId = 3,
                    Header = "Harassment or bullying",
                    Description = "Downvoted my clash entry and left a rude comment.",
                    Status = ReportStatus.Dismissed,

...
namespace Flix.Services.Database.Migrations
{
    ...
    [Migration("20260826113622_MovieRequestAdminComment")]
    partial class MovieRequestAdminComment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flix.Services.Database.MovieRequest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            AdminComment = "The title you sent in is already in the catalogue under its original name, so there is nothing to add.",
